<template>
     <footer class="w-full bg-white dark:bg-dark flex justify-center dark:border-dark-2 border-t-2 px-5">
          <div class="w-full max-w-[1100px] flex flex-col">
               <div class="flex flex-col items-center justify-center gap-7 md:flex-row md:justify-between md:items-center py-6">
                    ...
                    <div class="text-lg flex gap-5">
                         ...
                         <a class="dark:text-gray-400 dark:hover:text-white text-gray-500 hover:text-black" href="https://github.com/Adryanssyah" target="_blank" aria-label="Kunjungi github Saya"> <i class="bi bi-github"></i></a>
                    </div>
               </div>
          </div>
     </footer>
